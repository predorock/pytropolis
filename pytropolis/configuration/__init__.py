...
def get_configuration():
    ...
    execution_dir   = os.environ.get('PYT_EXECUTION_DIR',  os.path.join(home_dir, 'executions'))
    log_dir         = os.environ.get('PYT_LOG_DIR',        os.path.join(home_dir, 'logs'))
    venv_container  = os.environ.get('PYT_VENV_CONTAINER', os.path.join(home_dir, 'venv_container'))
    ...
    #topics
    execution_topic = os.environ.get('PYT_EXECUTION_TOPIC', 'pytropolis.execution')
    # queue name
